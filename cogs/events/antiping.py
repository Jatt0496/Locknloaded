        ...
        with open("blacklist.json", "r") as f:
          ...
          if message.mention_everyone:
            ...
            if str(message.author.id) in data2["ids"]:
              ...
              embed = discord.Embed(description=f"""\nHey,Hey, I'm Lock N Loaded 
To view all my modules do `-help`.
For module related help use `-help <module name>` If you continue to have problems, consider asking for help Support Server By Clicking [here](https://discord.gg/lnl)`.""",color=0x50101) 
