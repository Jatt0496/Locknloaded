...
#<:volume_down:1056039813712707654>
    ...
    @discord.ui.button(emoji="<:Icon_SpeakerLow:1102006779593887774>",
    ...
    @discord.ui.button(emoji="<:rewind:1102008333650640946> ",
                       style=discord.ButtonStyle.grey,
                       row=0)
    ...
    @discord.ui.button(emoji="<:artic_stop:1102008885981761536>",
    ...
    @discord.ui.button(emoji="<:next:1102009600854741123>",
                       style=discord.ButtonStyle.grey,
                       row=0)
...
class Music(commands.Cog):
        ...
        if 'https://open.spotify.com' in str(search):
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x50101,
                    description=
                    f"<a:Playing:1102128435700187268> [{track.title}](https://discord.gg/lnl)"
                )
                ...
                mbed.add_field(name="<:stage:1102128864785879121> Song By",
                               value=f"`{track.author}`")
                mbed.add_field(name="<:icons_uptime:1102129280936312874> Duration",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track}](https://discord.gg/lnl) Added To The Queue',
                    color=0x50101)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x50101,
                    description=
                    f"<a:Playing:1102128435700187268> [{track1}](https://discord.gg/lnl)"
                )
                ...
                embed = discord.Embed(
                    description=
                    f'[{track1}](https://discord.gg/lnl) Added To The Queue',
                    color=0x50101)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x50101,
                    description=
                    f"<a:Playing:1102128435700187268> [{track2.title}](https://discord.gg/lnl)"
                )
                ...
                embed = discord.Embed(
                    description=
                    f'[{track2}](https://discord.gg/lnl) Added To The Queue',
                    color=0x50101)
        ...
        if not player.queue.is_empty:
            ...
            if hasattr(new_song, 'thumb'):
                mbed = discord.Embed(
                    color=0x50101,
                    description=
                    f"<a:Playing:1102128435700187268> [{new_song.title}](https://discord.gg/lnl)"
                )
                #mbed.add_field(name="<a:playing:1091344170360254464> ", value=f"[{new_song.title}](https://discord.gg/UbNACx2unG)")
                #mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name="<:stage:1102128864785879121> Song By",
                ...
                mbed.add_field(
                    name="<:a_users:1102138971963797554> Requested By",
    ...
    async def boost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<a:tick:1072492486674616460> | Successfully enabled `bass boost` .",
            color=0x50101)
    ...
    async def rmvboost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<a:tick:1072492486674616460> | Successfully disabled `bass boost` .",
            color=0x50101)
        await ctx.reply(embed=hacker4)
    ...
    async def playing(self, ctx):
        ...
        em = discord.Embed(
            description=f"[{vc.track}](https://discord.gg/lnl)",
            color=0x50101)
