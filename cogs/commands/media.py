...
class Media(commands.Cog):
    ...
    async def setup(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<a:tick:1072492486674616460> | Successfully added {channel.mention} in media only channels.")
    ...
    async def remove(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<:codez_cross:1022362833834483762> | Successfully removed {channel.mention} from media only channels.")
    ...
    async def reset(self, ctx):
        ...
        await ctx.send("<a:tick:1072492486674616460> | Successfully removed all the media only channels.")
